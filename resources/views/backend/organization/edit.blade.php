<x-app>
  ...
  <x-slot:pageTitle>Edit Organization</x-slot:pageTitle>
        ...
        <div class="border-b border-gray-900/10 pb-12">
          ...
          <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            <div class="col-span-full">
              ...
              @enderror
              <div class="mt-2">
                <input type="text" value="{{$org->name}}" name="name" id="name" autocomplete="name"
            ...
            <div class="col-span-full">
              ...
              <div class="mt-2">
                <textarea id="about" name="about" rows="3"
                  class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 @error('about') ring-red-600 @enderror sm:text-sm sm:leading-6">{{$org->about}}</textarea>
              </div>
            ...
            <div class="sm:col-span-2 sm:col-start-1">
              ...
              @enderror
              <div class="mt-2">
                <input type="text" value="{{$org->address}}" name="address" id="address" autocomplete="address"
            ...
            <div class="sm:col-span-2">
              ...
              @enderror
              <div class="mt-2">
                <input type="text" value="{{$org->phone}}" name="phone" id="phone" autocomplete="phone"
            ...
            <div class="sm:col-span-2">
              ...
              @enderror
              <div class="mt-2">
                <input type="email" value="{{$org->email}}" name="email" id="email" autocomplete="email"
